...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/system_tb/simulation/submodules/altera_avalon_sc_fifo.v"                                       -work JTAG_avalon_jtag_slave_agent_rsp_fifo -cdslib ./cds_libs/JTAG_avalon_jtag_slave_agent_rsp_fifo.cds.lib
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/system_tb/simulation/submodules/altera_merlin_slave_agent.sv"                                  -work JTAG_avalon_jtag_slave_agent          -cdslib ./cds_libs/JTAG_avalon_jtag_slave_agent.cds.lib         
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/system_tb/simulation/submodules/altera_merlin_burst_uncompressor.sv"                           -work JTAG_avalon_jtag_slave_agent          -cdslib ./cds_libs/JTAG_avalon_jtag_slave_agent.cds.lib         
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/system_tb/simulation/submodules/altera_merlin_slave_translator.sv"                             -work JTAG_avalon_jtag_slave_translator     -cdslib ./cds_libs/JTAG_avalon_jtag_slave_translator.cds.lib    
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/system_tb/simulation/submodules/system_LEDs.v"                                                 -work LEDs                                  -cdslib ./cds_libs/LEDs.cds.lib                                 
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/system_tb/simulation/submodules/altera_conduit_bfm_0003.sv"                                    -work system_inst_leds_bfm                  -cdslib ./cds_libs/system_inst_leds_bfm.cds.lib                 
