...
module system_mm_interconnect_0 (
	...
	wire  [90:0] jtag_avalon_jtag_slave_agent_rf_source_data;                               // JTAG_avalon_jtag_slave_agent:rf_source_data -> JTAG_avalon_jtag_slave_agent_rsp_fifo:in_data
	...
	wire  [90:0] jtag_avalon_jtag_slave_agent_rsp_fifo_out_data;                            // JTAG_avalon_jtag_slave_agent_rsp_fifo:out_data -> JTAG_avalon_jtag_slave_agent:rf_sink_data
	...
	wire  [89:0] cmd_mux_src_data;                                                          // cmd_mux:src_data -> JTAG_avalon_jtag_slave_agent:cp_data
	...
	wire  [90:0] cpu_debug_mem_slave_agent_rf_source_data;                                  // CPU_debug_mem_slave_agent:rf_source_data -> CPU_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire  [90:0] cpu_debug_mem_slave_agent_rsp_fifo_out_data;                               // CPU_debug_mem_slave_agent_rsp_fifo:out_data -> CPU_debug_mem_slave_agent:rf_sink_data
	...
	wire  [89:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> CPU_debug_mem_slave_agent:cp_data
	...
	wire  [89:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> RAM_s1_agent:cp_data
	...
	wire   [5:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> LEDs_s1_agent:cp_channel
	...
	wire  [13:0] display_s1_agent_m0_address;                                               // DISPLAY_s1_agent:m0_address -> DISPLAY_s1_translator:uav_address
	...
	wire  [90:0] display_s1_agent_rf_source_data;                                           // DISPLAY_s1_agent:rf_source_data -> DISPLAY_s1_agent_rsp_fifo:in_data
	...
	wire  [90:0] display_s1_agent_rsp_fifo_out_data;                                        // DISPLAY_s1_agent_rsp_fifo:out_data -> DISPLAY_s1_agent:rf_sink_data
	...
	wire         cmd_mux_005_src_valid;                                                     // cmd_mux_005:src_valid -> DISPLAY_s1_agent:cp_valid
	wire  [89:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> DISPLAY_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                     // DISPLAY_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [5:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> DISPLAY_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                             // cmd_mux_005:src_startofpacket -> DISPLAY_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                               // cmd_mux_005:src_endofpacket -> DISPLAY_s1_agent:cp_endofpacket
	...
	wire  [89:0] jtag_avalon_jtag_slave_agent_rp_data;                                      // JTAG_avalon_jtag_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [89:0] cpu_debug_mem_slave_agent_rp_data;                                         // CPU_debug_mem_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [89:0] ram_s1_agent_rp_data;                                                      // RAM_s1_agent:rp_data -> router_004:sink_data
	...
	wire         display_s1_agent_rp_valid;                                                 // DISPLAY_s1_agent:rp_valid -> router_007:sink_valid
	wire  [89:0] display_s1_agent_rp_data;                                                  // DISPLAY_s1_agent:rp_data -> router_007:sink_data
	wire         display_s1_agent_rp_ready;                                                 // router_007:sink_ready -> DISPLAY_s1_agent:rp_ready
	wire         display_s1_agent_rp_startofpacket;                                         // DISPLAY_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         display_s1_agent_rp_endofpacket;                                           // DISPLAY_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         display_s1_agent_rdata_fifo_src_valid;                                     // DISPLAY_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] display_s1_agent_rdata_fifo_src_data;                                      // DISPLAY_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         display_s1_agent_rdata_fifo_src_ready;                                     // avalon_st_adapter_005:in_0_ready -> DISPLAY_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                         // avalon_st_adapter_005:out_0_valid -> DISPLAY_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                          // avalon_st_adapter_005:out_0_data -> DISPLAY_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                         // DISPLAY_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                         // avalon_st_adapter_005:out_0_error -> DISPLAY_s1_agent:rdata_fifo_sink_error
